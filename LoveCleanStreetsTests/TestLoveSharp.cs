...
namespace LoveSharpTests
{
    ...
    class TestLoveSharp
    {
        ...
        {
            //return StreamingUnit.Execute<LoveSharpMapper, LoveSharpReducer>(data);
            throw new NotImplementedException();
        }
        [Test]
        public void LoveSharpMapper_FilterLA_ThreeItemsFromMapper()
        {
        ...
        [Test]
        public void LoveSharpMapper_FilterLA_TwoItemsFromReducer()
        {
            var result = run(new[] { Report1, Report2, Report3, Report4 });
            result.ReducerResult.Count.Should().Be(2);
        }
        ...
        [Test]
        public void LoveSharpMapper_FilterLA_CheckReducerTwoPartsToLine()
        {
            var result = run(new[] { Report1, Report2, Report3, Report4 });
        ...
        [Test]
        public void LoveSharpMapper_FilterLA_CheckReducerCountReports()
        {
            var result = run(new[] { Report1, Report2, Report3, Report4 });
        ...
        [Test]
        public void LoveSharpMapper_FilterLA_CheckReducerCountReportsByDay()
        {
